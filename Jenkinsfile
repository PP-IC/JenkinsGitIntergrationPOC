            ...
            steps {
                script {
                    ...
                    if (RE_ENV == 'X951Q3') {
                        ...
                        """
                        powershell 'Compress-Archive Screenshots Screenshots_Build_env.BUILD_NUMBER.zip'
                        powershell 'Compress-Archive test-output test-output_Build_env.BUILD_NUMBER.zip'
